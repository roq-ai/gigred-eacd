...
function OrganizationUserListPage() {
  ...
  const handleView = (id: string) => {
    if (hasAccess('organization_user', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)) {
      router.push(`/organization-users/view/${id}`);
    }
  };
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          ...
          {hasAccess('organization_user', AccessOperationEnum.CREATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/organization-users/create`} passHref legacyBehavior>
                  ...
                  <Tr cursor="pointer" onClick={() => handleView(record.id)} key={record.id}>
                    ...
                    <Td>
                      {hasAccess('organization_user', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                        <NextLink href={`/organization-users/edit/${record.id}`} passHref legacyBehavior>
                          <Button
